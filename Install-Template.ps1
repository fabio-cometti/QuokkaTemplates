$shortName = "quokkacasln"
$id = "Quokka.Templates.CleanArchitectureSolution"
...
#dotnet new -i ".\packages\$id.*.nupkg"

Copy-Item -Path ".\packages\$id.*.nupkg"  -Destination ".\src\QuokkaTemplatesVSIX\Assets\" -Force
